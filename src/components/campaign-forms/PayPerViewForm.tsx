...
import { CalendarIcon, Link as LinkIcon, CheckSquare, Percent } from "lucide-react";
...
const PayPerViewForm = ({ campaign, onChange, showCreatorInfoSection = true }: PayPerViewFormProps) => {
